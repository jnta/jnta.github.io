...
description: "Como criar imagens Docker eficientes e seguras para aplicações Spring Boot usando builds multi-stage com Gradle."
date: 2023-12-18
category: "DevOps"
tags: [docker, gradle, spring_boot]
stack: [Docker, Gradle, Spring Boot]
topic: "DevOps"
cover: "multi-stage"
---
